...
export class MovesService {
  ...
  moves: Moves[] = [
    ...
    { id: 1, season: 2021, moves: 25, draft: 8 },
    { id: 2, season: 2021, moves: 18, draft: 6 },
    { id: 3, season: 2021, moves: 26, draft: 4 },
    { id: 4, season: 2021, moves: 5, draft: 3 },
    { id: 5, season: 2021, moves: 14, draft: 1 },
    { id: 11, season: 2021, moves: 14, draft: 7 },
    { id: 17, season: 2021, moves: 23, draft: 5 },
