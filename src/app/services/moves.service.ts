...
export class MovesService {
  ...
  moves: Moves[] = [
    ...
    { id: 2, season: 2021, moves: 20, draft: 6 },
    { id: 3, season: 2021, moves: 34, draft: 4 },
    { id: 4, season: 2021, moves: 6, draft: 3 },
    { id: 5, season: 2021, moves: 18, draft: 1 },
    { id: 11, season: 2021, moves: 17, draft: 7 },
    { id: 17, season: 2021, moves: 28, draft: 5 },
